...
class ChannelName extends StatefulWidget {
	...
	@override
	_ChannelNameState createState() => _ChannelNameState(channelName);
}

class _ChannelNameState extends State<ChannelName> {

	final String channelName;
	_ChannelNameState(this.channelName);
	...
	Widget build(BuildContext context) {
        ...
        title: Row(
	        	...
	        	children: <Widget> [
	        		...
	        		Container(
	        		child:Text(channelName, style:TextStyle(color: Colors.black)),
	        		),
		        	Container(
            	...
            	child: Row(
            		mainAxisAlignment: MainAxisAlignment.spaceBetween,
	            		...
	            		Container(
	            			...
	            			child: GestureDetector(
	            				onTap: () {
	            					Navigator.push(context,MaterialPageRoute(builder: (context) => Followers(channelName)),);
	            				},
	            				child: Column(
	            					children: <Widget>[
	            						Text('24k',
	            	...
	            	//		padding: EdgeInsets.only(left:30),
	            			child: GestureDetector(
	            				onTap: () {
	            					Navigator.push(context,MaterialPageRoute(builder: (context) => Following(channelName)),);
	            				},
	            				child: Column(
	            					children: <Widget>[
	            						Text('98k',
